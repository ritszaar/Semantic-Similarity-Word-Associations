...
while True:
    ...
    if index >= 0 and index < 10000:
        ...
        stat.add_row(["P@1",  "{:.2f}%".format(precision_at_1  * 100)])
        stat.add_row(["P@5",  "{:.2f}%".format(precision_at_5  * 100)])
        stat.add_row(["P@10", "{:.2f}%".format(precision_at_10 * 100)])
        stat.add_row(["P@15", "{:.2f}%".format(precision_at_15 * 100)])
        stat.add_row(["P@20", "{:.2f}%".format(precision_at_20 * 100)])
        stat.add_row(["HP@1",  "{:.2f}%".format(h_precision_at_1  * 100)])
        stat.add_row(["HP@5",  "{:.2f}%".format(h_precision_at_5  * 100)])
        stat.add_row(["HP@10", "{:.2f}%".format(h_precision_at_10 * 100)])
        stat.add_row(["HP@15", "{:.2f}%".format(h_precision_at_15 * 100)])
        stat.add_row(["HP@20", "{:.2f}%".format(h_precision_at_20 * 100)])
